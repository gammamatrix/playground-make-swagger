...
use Playground\Make\OpenAPI\Configuration\OpenAPI\Api;
use Symfony\Component\Yaml\Exception\ParseException;
use Symfony\Component\Yaml\Yaml;

/**
 * \Playground\Make\OpenAPI\Building\BuildOpenAPI
 */
trait BuildOpenAPI
{
    protected Api $api;
    ...
    protected function init_openapi_api(): void
    {
        if (empty($this->api)) {
            $this->api = new Api;
